...
//     {
//         Schema::create('xpersonal_confirmation', function (Blueprint $table) {
//             $table->id();
...
//             $table->date('FatherBirth')->nullable();
//             $table->string('MotherName')->nullable();
//             $table->date('MotherBirth')->nullable();
...
//     {
//         Schema::dropIfExists('xpersonal_confirmation');
//     }
// };
